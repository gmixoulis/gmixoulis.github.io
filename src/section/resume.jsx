                        ...
                        <ul className="d_timeline">
                            <li className="d_timeline-item">
                                ...
                                <p className="d_timeline-text">
                                	...
                                	<span className="d_company">Aristotle University of Thessaloniki</span>The main topic is the specialization in Data and Web Science. The efficient and effective data management is a critical. Challenges arise at all levels of
                                     the Information Technology Stage in terms of infrastructure, management, access, and exploitation 
                                     of information for knowledge mining that will be provided in a direct way.
                                     <br></br> <br></br>
                                     <strong style={{color:"pearl"}}>Courses:</strong> Blockchain, Big Data (Scala - Spark), Advanced Machine Learning, Web Data Mining, Natural Language Processing, etc.
                            ...
                            <li className="d_timeline-item">
                                ...
                                <p className="d_timeline-text">
                                	...
                                	<span className="d_company">University of Macedonia</span>Information and Communication Technologies can be 
                                    efficiently implemented if there is sound knowledge not only of the Science of Informatics but also of the scope 
                                    of its application. Thus, students are required to attend advanced courses in Management Science, Economics, Finance,
                                     Business Administration, Quantitative Methods, as well as Computer and Internet Law. 
                                     <br></br> <br></br>
                                     <strong style={{color:"pearl"}}>Courses:</strong> Cryptography, Computer Architecture, Operating Systems, Neural Networks, OO Programming (Java), Blockchain, Big Data Mining, etc.
                                </p>
                            </li>
